...
- I refined CLAUDE.md so that the commit no longer contains information that it was done with Claude
- I refined CLAUDE.md so that with every commit, phpstan and phpcsfixer are run automatically
