...
- Tomorrow I want to add a new rule to CLAUDE.md describing Pair Programming where the assistant is the Driver who writes the code and I am the Navigator making strategic decisions—maybe this will make it even more obedient.
