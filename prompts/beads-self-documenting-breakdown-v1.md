# Beads Self-Documenting Breakdown — v1

> **Version:** v1 · **Status:** Current. Next candidate trialed in [`beads-self-documenting-breakdown-v2.md`](./beads-self-documenting-breakdown-v2.md) (Testing).
> Which version is blessed is tracked in the pointer file [`beads-self-documenting-breakdown.md`](./beads-self-documenting-breakdown.md).
